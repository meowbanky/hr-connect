        ...
        <div class="w-full lg:w-7/12 p-6 md:p-10 lg:p-12 flex flex-col">
            <div class="max-w-[480px] mx-auto w-full flex-1 flex flex-col justify-center">
                ...
                <div class="text-center mb-8">
                    <h1 class="text-2xl md:text-3xl font-bold text-text-main dark:text-white mb-2">Welcome Back</h1>
                    <p class="text-text-secondary dark:text-slate-400">Please enter your details to sign in.</p>
                </div>
